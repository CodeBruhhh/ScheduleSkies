...
const ProfilePage = () => {
  ...
  // NEW: Top-level page loading state
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // UNCOMMENT the next line if you want to force a 1-second delay to test the spinner!
      ...
      <div className={eventStyles.appContainer}>
        ...
        <main className={eventStyles.mainContent} style={{ padding: 0 }}>
          <div 
            style={{ 
              display: 'flex', 
              flexDirection: 'column', /* This forces the text UNDER the spinner */
          ...
          >
            ...
            <p 
              style={{ 
                ...
                fontSize: '14px', 
                fontWeight: '500', 
                margin: '16px 0 0 0', /* Adds exactly 16px of space above the text */
                textAlign: 'center' /* Centers the text string itself */
              }}
            >
